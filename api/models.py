...
class Project (models.Model):
    ...
    logo = models.URLField(max_length=200, null=True, help_text="link of the project logo")
    web_page = models.URLField(max_length=200, null=True, help_text="link of the project web page")
    description = models.TextField()
    details = models.TextField()
    repo = models.URLField(max_length=200, null=True, help_text="link of the project repository")
